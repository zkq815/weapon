package com.zkq.alldemo.costomview.colorprogresswithspeed;
...
public class ColorProgressWithSpeed extends View {
    ...
    public ColorProgressWithSpeed(Context context) {
        super(context, null);
        initView();
    }

    public ColorProgressWithSpeed(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
        initCofig(context, attrs);
        initView();
    }

    public ColorProgressWithSpeed(Context context, AttributeSet attrs, int defStyleAttr) {
