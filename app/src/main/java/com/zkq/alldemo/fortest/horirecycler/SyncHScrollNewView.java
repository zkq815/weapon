...
/**
 * @author zkq
 * create:2019/11/15 5:41 PM
 * email:zkq815@126.com
 * desc: 新版横向滑动view
 */
public class SyncHScrollNewView extends HorizontalScrollView {
    ...
    public SyncHScrollNewView(Context context) {
        super(context);
    }

    public SyncHScrollNewView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SyncHScrollNewView(Context context, AttributeSet attrs, int defStyleAttr) {
