...
import com.zkq.alldemo.fortest.gsvideo.gsdemo.gsyvideoplayer.video.RequestListADVideoPlayer;
import com.zkq.alldemo.fortest.gsvideo.gsdemo.gsyvideoplayer.video.SampleCoverVideo;
...
public class ListADVideoActivity2 extends AppCompatActivity {
    ...
    public class ListADNormalAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (position % 2 == 0) {
                holder.gsyVideoPlayer.loadCoverImage(url, R.drawable.xxx1);
            } else {
                holder.gsyVideoPlayer.loadCoverImage(url, R.drawable.xxx2);
            }
