            ...
            public void run() {
                try {
                    if (mCryptoObject != null) {
                        ...
                        // of the fingerprint.
                        if (!initCipher()) {
//                            ZLog.e("Failed to init Cipher.");
                        }
                    }
                } catch (Exception e) {
//                    ZLog.e(" Failed to init Cipher, e:" + Log.getStackTraceString(e));
                }
...
//            ZLog.e(" Failed to createKey, e:" + Log.getStackTraceString(e));
...
//            ZLog.e(" Failed to initCipher, e:" + Log.getStackTraceString(e));
            return false;
