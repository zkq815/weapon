 ...
 * desc: 添加背景和文字
 */
public class ZkqSpan extends ImageSpan {
    ...
    public ZkqSpan(Drawable d) {
        super(d);
        mTextBound = new Rect();
    }

    public ZkqSpan setTimerTextColor(int mTextColor) {
        this.mTextColor = mTextColor;
        return this;
    }
   public ZkqSpan setTimerTextSize(int textSize){
       this.mTextSize = textSize;
       return this;
   }
    public ZkqSpan setTimerPadding(int left,int top,int right,int bottom){
    ...
    public void draw(Canvas canvas, CharSequence text,
        ...
        canvas.drawText(text.subSequence(start, end).toString()
                , x + mGapX , y - mGapY + maxHeight/3, paint);
    }
}
