...
import com.zkq.alldemo.fortest.gsvideo.gsdemo.gsyvideoplayer.simple.SimpleActivity;
import com.zkq.alldemo.fortest.gsvideo.gsdemo.gsyvideoplayer.utils.JumpUtils;
...
public class GsMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gsvideo_main);
        Debuger.enable();
    ...
    private void initView(){
        ...
        findViewById(R.id.open_btn_empty).setOnClickListener(this);
        ...
        findViewById(R.id.open_btn_auto).setOnClickListener(this);
        findViewById(R.id.open_scroll).setOnClickListener(this);
        findViewById(R.id.open_window).setOnClickListener(this);
        findViewById(R.id.open_btn_ad).setOnClickListener(this);
        findViewById(R.id.open_btn_multi).setOnClickListener(this);
        findViewById(R.id.open_btn_ad2).setOnClickListener(this);
        findViewById(R.id.open_list_ad).setOnClickListener(this);
        findViewById(R.id.open_custom_exo).setOnClickListener(this);
        findViewById(R.id.open_simple).setOnClickListener(this);
        findViewById(R.id.open_switch).setOnClickListener(this);
        findViewById(R.id.media_codec).setOnClickListener(this);
    }
...
//            , R.id.recycler, R.id.recycler_2, R.id.list_detail_list, R.id.web_detail
//            , R.id.danmaku_video, R.id.fragment_video, R.id.more_type, R.id.input_type, R.id.open_btn_empty, R.id.open_control
//            , R.id.open_filter, R.id.open_btn_pick, R.id.open_btn_auto, R.id.open_scroll
//            , R.id.open_window, R.id.open_btn_ad, R.id.open_btn_multi, R.id.open_btn_ad2, R.id.open_list_ad, R.id.open_custom_exo
//            , R.id.open_simple, R.id.open_switch, R.id.media_codec})
    @Override
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.clear_cache:
                //清理缓存
                GSYVideoManager.instance().clearAllDefaultCache(GsMainActivity.this);
