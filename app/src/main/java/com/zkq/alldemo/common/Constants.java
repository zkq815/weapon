...
public class Constants {
    ...
    public static final String INTENT_DATA_PACKAGE_SPU = "pkg_spu";
    public static final String INTENT_DATA_PACKAGE_BEAN_ITEM = "pkg_bean_item";
    public static final String INTENT_DATA_BUY_COUNT = "buy_count";
    public static final String INTENT_DATA_PACKAGE_CHOOSE_BEAN = "package_choose_bean";
    public static final String INTENT_DATA_DISCOUNT_ITEM = "discount_item";

    public static final String INTENT_DATA_USER_ICON_URL = "icon_url";
    public static final String INTENT_DATE_USER_NICKNAME = "nick_name";

    public static final String FLAVOR_MEIZU = "meizu";
    public static final String FLAVOR_FLYME = "flyme";
    ...
    public static final String XIAONENG_GROUP = "zu_1000_9999";
