...
/**
 * @author zkq
 * create:2019/5/28 11:46 PM
 * email:zkq815@126.com
 * desc: 解决了 notify动画时 DelegateAdapter的getLayoutPosition的调用，引发的crash
 */
public class JCDelegateAdapter extends VirtualLayoutAdapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position, List<Object> payloads) {
        ...
        holder.itemView.setTag(R.id.m_base_key_delegate_adapter, pair.second);
    }
...
//        }
    ...
    public void onViewRecycled(RecyclerView.ViewHolder holder) {
        ...
        Adapter adapter = (Adapter) holder.itemView.getTag(R.id.m_base_key_delegate_adapter);
        if (adapter == null) {
            ToolException.printStackTrace(JCDelegateAdapter.class.getSimpleName(),
                    new IllegalArgumentException("onViewRecycled() holder.itemView 未设置 adapter"));
            return;
        }
    ...
    public void onViewAttachedToWindow(RecyclerView.ViewHolder holder) {
        ...
        if (adapter == null) {
            ToolException.printStackTrace(JCDelegateAdapter.class.getSimpleName(),
                    new IllegalArgumentException("onViewAttachedToWindow() holder.itemView 未设置 adapter"));
            return;
        }
    ...
    public void onViewDetachedFromWindow(RecyclerView.ViewHolder holder) {
        ...
        if (adapter == null) {
            ToolException.printStackTrace(JCDelegateAdapter.class.getSimpleName(),
                    new IllegalArgumentException("onViewDetachedFromWindow() holder.itemView 未设置 adapter"));
            return;
        }
