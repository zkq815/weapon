...
import com.zkq.weapon.basehodler.adapter.AdapterLoadMoreWithBottomView;
...
public class RecyclerViewLoadMoreWithBottomView extends RecyclerView {
     ...
     */
    public void setBottomViewClickListener(OnClickListener listener, @IdRes int... resIds) {
        if (mLoadMoreRefreshAdapter != null) {
